...
① **الاحتمالات**: هل $\\sum P(X=x_i) = 1$ تماماً؟ هل مجموع أغصان كل عقدة = 1؟
...
• ابدأ دائماً برسم الشجرة قبل أي حساب.
• قاعدة التحديث في الاحتمالات الشرطية (سحب من صندوقين): عند الانتقال للمرحلة التالية، أعِد حساب العدد الكلي للكرات ($n$) في الصندوق التالي بناءً على ما حدث في السحب الأول (إعادة أو حذف أو نقل الكرة).
• تحقّق قبل الانتقال: مجموع احتمالات الأغصان الخارجة من نفس العقدة = 1 تماماً.
...
• احسب $P(X=x_i)$ لكل قيمة.
• **قبل عرض جدول التوزيع**: تحقق أن $\\sum P(X=x_i) = 1$ — إذا لم يتطابق، أعِد مراجعة مسارات الشجرة وصحِّح بصمت.
