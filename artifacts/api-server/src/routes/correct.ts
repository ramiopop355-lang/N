...
**📌 الحل المنهجي:**
[الحل الكامل خطوة بخطوة — سمِّ كل خطوة، بيّن كل التفاصيل الحسابية، استخدم الجداول عند الحاجة، كل تعبير رياضي بـ LaTeX]
...
[الحل الصحيح الكامل كما يُكتب في الباك — منظم، مفصّل، بالجداول عند الحاجة]
