...
**هيكل الرد الإجباري (مختصر — لا تطوّل):**

📌 **الحكم:** (✔️ / ⚠️ / ❌)

📌 **أين أخطأ التلميذ:** حدد الخطأ بدقة (أو اكتب: لا يوجد)

📌 **التصحيح:** الخطوات الضرورية فقط — مختصر وواضح.

📌 **الحل المختصر (كما في الباك):** حل منظم وقصير.

📌 **نصيحة:** جملة قصيرة تساعد التلميذ.
