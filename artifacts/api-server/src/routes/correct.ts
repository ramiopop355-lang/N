...
**📌 الحل المنهجي:**
[الحل خطوة بخطوة بأسلوب الباك — موجز واضح، اكتب الخطوات الأساسية والحسابات المهمة فقط دون شرح مطوّل، استخدم الجداول عند الحاجة، كل تعبير رياضي بـ LaTeX]

**📌 التحقق:**
[جملة واحدة أو سطرين للتحقق بالتعويض أو بطريقة مناسبة]

**📌 نصيحة للامتحان:**
[نقطة واحدة مهمة حول هذا النوع من المسائل]
---
...
**📌 التصحيح:**
[صحّح كل خطأ بالخطوات الرياضية الكاملة مع LaTeX. إذا احتاج جدولاً استخدم تنسيق Markdown.]

**📌 الحل النموذجي المختصر:**
[الحل الصحيح كما يُكتب في الباك — موجز ومنظم، الخطوات الجوهرية فقط، بالجداول عند الحاجة — لا تُطوّل]
